...
function Contacts({currentUser, contacts, changeCurrentChat}) {
  ...
  useEffect(() => {
    if (!currentUser) {
      ...
      const userImage = JSON.stringify(localStorage.getItem('User-avatar')).split('\\"')[1];
